...
## 3.4.3.1. Four-bit binary counter
### Module Declaration
난이도: ★☆☆☆☆
```verilog
module top_module (
...
## 3.4.3.2. Decade counter (Count10)
### Module Declaration
난이도:  ★☆☆☆☆
```verilog
module top_module (
...
## 3.4.3.3. Decade counter again (Count1to10)
### Module Declaration
난이도:  ★☆☆☆☆
```verilog
module top_module (
...
## 3.4.3.4. Slow decade counter Countslow (Countslow) 
### Module Declaration
난이도:  ★★☆☆☆
```verilog
module top_module (
...
## 3.4.3.5. Counter 1-12 (Exmas/ece241 2014 q7a)
### Module Declaration
난이도:  ★★★★☆
```verilog
module top_module (
...
## 3.4.3.6. Counter 1000 (Exams/ece241 2014 q7b)
### Module Declaration
난이도:  ★★★☆☆
```verilog
module top_module (
...
## 3.4.3.7. 4-digit decimal counter (Countbcd)
### Module Declaration
난이도: ★★★☆☆
```verilog
module top_module (
...
## 3.4.3.8. 12-hour clock (Count clock)
### Module Declaration
난이도: ★★★★☆
```verilog
module top_module(
